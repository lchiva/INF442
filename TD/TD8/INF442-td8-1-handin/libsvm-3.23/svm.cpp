...
private:
	...
	double ratquad(int i, int j) const
	{
	  ...
	  gamma(param.gamma), coef0(param.coef0)
{
	...
	case PRECOMPUTED:
		...
		// Add rational-quadratic kernel here
	case RATQUAD:
		kernel_function = &Kernel::ratquad;
		break;
	}

	clone(x, x_, l);

	// You should probably adapt this as well
	if (kernel_type == RBF)
	{
...
static const char *kernel_type_table[] =
	{
		"linear", "polynomial", "rbf", "sigmoid", "precomputed", "ratquad",
...
int svm_save_model(const char *model_file_name, const svm_model *model)
{
	...
	if (param.kernel_type == POLY || param.kernel_type == SIGMOID || param.kernel_type == RATQUAD
		// coef0 is also a parameter for rational-quadratic kernel
	)
